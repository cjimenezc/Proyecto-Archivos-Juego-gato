...
public class MDI_Gato extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Btn_ListasJugadores.setForeground(new java.awt.Color(0, 51, 153));
        Btn_ListasJugadores.setText("Lista Jugadores");
        Btn_ListasJugadores.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        Btn_ListasJugadores.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Btn_ListasJugadoresActionPerformed(evt);
            }
        });
    ...
    private void Btn_ListasJugadoresActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_ListasJugadoresActionPerformed

    }//GEN-LAST:event_Btn_ListasJugadoresActionPerformed
